...
## Notes
This is the third iteration of the dependency parser presented in Chapter 2 of Donnie Dunagan's dissertation, [Linguistic Dependency: Investigations into its Assignment and Processing](https://openscholar.uga.edu/record/26943?ln=en&v=pdf). It differs from the implementation presented there in that it no longer uses POS tags as features.
